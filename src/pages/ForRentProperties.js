            ...
            <div className="single-product-wrap style-2">
                ...
                <div className="product-details-inner">
                    ...
                    <ul className="meta-inner">
                        ...
                        <li>
                            <span className='text-success'>For Rent</span>
                        </li>
                    </ul>
                ...
                <div className='text-center ms-2 mt-4 mb-2'>
                    <Link to={"../Admin/ForRentProperties/Edit/Property/" + props.property._id} className="btn ps-3 pe-3 btn-primary">
                        edit
                    </Link>
...
export default class ForRentProperties extends Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:4000/ForRentProperties/')
            .then(response => {
                this.setState({
    ...
    deleteProperty(id) {
        axios.delete('http://localhost:4000/ForRentProperties/delete-forRentProperty/' + id)
    ...
    render() {
        return (
            <div>
                <h1 className='text-primary mb-5 text-center bg-white rounded p-4 me-5 ps-5'>For Rent Properties</h1>
                <div className=' ps-5 pt-5 pb-5 me-5 mb-5 rounded bg-white'>

                    <div className='text-end me-5 mb-5'>
                        <Link to={"../Admin/ForRentProperties/AddNew/"} className="btn btn-primary mb-4">
                            Add Property +
                        </Link>
                    </div>
