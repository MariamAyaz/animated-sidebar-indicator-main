...
export default function AddNewForSaleProperty(props) {
    ...
    useEffect(() => {
        axios.get('http://localhost:4000/ForSaleProperties/edit-forSaleProperty/' + id)
            .then((res) => {
    ...
    function submit(event) {
        ...
        axios.put('http://localhost:4000/ForSaleProperties/edit-forSaleProperty/' + id, property)
            .then(res => {
